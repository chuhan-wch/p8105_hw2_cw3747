...
(NA), the resulting tidy dataset contains **1188** observations spanning
**2014–2025**. Key variables include dumpster, date, weight (tons),
...
collected by Professor Trash Wheel is **282.26** tons, and Gwynnda
...
| ZIP | Borough | Neighborhood | Price (Jan 2020) | Price (Jan 2021) | Change (2021–2020) |
|:---|:---|:---|---:|---:|---:|
...
Comparing January 2021 to January 2020, the largest drop was in ZIP
**10007**, **New York**, **Lower Manhattan**, with a change of **-913**.
Most of the largest declines cluster in dense, high-rent neighborhoods
where demand fell during early pandemic waves (e.g., CBD/commuter-heavy
areas). Outer-borough ZIPs with relatively lower baseline rents show
smaller or mixed changes.
